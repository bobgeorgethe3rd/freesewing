...
import { frontBaseShoulder } from './frontBaseShoulder'

export const backBaseShoulder = {
  name: 'peach.backBaseShoulder',
  from: backDaisy,
  after: frontBaseShoulder,
  hide: {
    from: true,
  },
  draft: ({
    ...
    points.shoulderCp = utils
      ...
      .shiftFractionTowards(points.dartTip, options.bustDartFraction / 4)
