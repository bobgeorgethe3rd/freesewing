...
export const neckband = {
  ...
  options: {
    ...
    ...hood.options,
    //Constants
    useVoidStores: false, //Altered for Sydney
    neckbandOverlapSide: 'left', //Locked for Sydney
    neckbandOverlap: 0, //Locked for Sydney
    hoodGuides: false, //Locked for Sydney
  },
  after: [front],
