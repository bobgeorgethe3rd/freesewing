...
- About 2 - 2.5 metres (2.2 - 2.7 yards) of a suitable **main** fabric ([see Theobald Fabric Options](#fabric))
- (Optional) About 2 - 2.5 metres (2.2 - 2.7 yards) of a suitable **lining** fabric ([see Theobald Fabric Options](#fabric))
- About 0.5 - 1 metre (0.6 - 1.1 yards) of a suitable pocket fabric. This can be cut out of the above if you are lining the trousers. ([see Theobald Fabric Options](#fabric))
- Interfacing
- (Optional) Zipper
- (Optional) Buttons
...
- Cut **1 or 2 Waistband Right** parts. (1 for folded, 2 for not folded)
- (If Fisthail) Cut **1 or 2 Waistband Fishtail Left** parts. (1 for embedded, 2 for not embedded)
...
- Cut **1 Waistband Right** parts. (in half if folded)
...
If you use a smaller hem allowance with the lining you can turn an amount of the main fabric to the inside for a cleaner finish.
...
You may wish to flatline the linings instead, this needs to be done either before the you sew the cross and crotch seams or before sewing the flys.
If making pleated version you may find it better to cut out a non-pleated front and use that as a lining.
...
### Step 8: Buttons and Buttonholes

### Step 9: Enjoy!

Now enjoy your new trousers! Just try not to travel back in time too far with them.	
