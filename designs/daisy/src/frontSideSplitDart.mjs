export const frontSideSplitDart = ({
  store,
  sa,
  points,
  Point,
  ...
  points.bustDartBottomLeft = points.bustDartBottom.shiftFractionTowards(
    points.sideWaist,
    options.bustDartFraction
  )
  points.bustDartTopRight = points.bustDartTop.shiftTowards(
    points.armhole,
    points.bustDartBottom.dist(points.bustDartBottomLeft)
  )
  ...
  if (complete) {
    ...
    //scalebox
    points.scalebox = points.armholeCpTarget
    macro('scalebox', {
      at: points.scalebox,
    })
