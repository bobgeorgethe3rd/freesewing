export const front2WaistDart = ({
  ...
  points.bustDartEdge = utils.beamsIntersect(
    points.waistDartRight,
    points.waistDartRight.shift(
      points.waistDartRight.angle(points.sideWaistInitial.rotate(-bustDartAngle, points.bust)),
      1
    ),
    points.bust,
    points.bustDartMid
  )
  points.sideWaist = points.sideWaist.rotate(bustDartAngle, points.bust)
    ...
    if (sa) {
      ...
      points.saSideWaist = utils.beamsIntersect(
        points.waistDartRight
          ...
          .rotate(-90, points.waistDartRight.rotate(bustDartAngle, points.bust)),
        points.sideWaist
          .shiftTowards(points.waistDartRight.rotate(bustDartAngle, points.bust), sa)
      ...
      points.saBustDartTop = utils.beamsIntersect(
        ...
        points.saBustDartEdge.shift(points.bustDartEdge.angle(points.bustDartTop), 1)
      )
