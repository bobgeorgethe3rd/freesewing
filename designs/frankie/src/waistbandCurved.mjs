...
const waistbandWidth = waistbandLengthTop > waistbandLength
...
const topCpDistance = (4 / 3) * (radius - absoluteOptions.waistbandWidth) * Math.tan(angleRads / 8)
...
points.bottomLeftCp2 = points.bottomLeft
      ...
      points.bottomRightCp1 = points.bottomLeftCp2.flipX(
        points.bottomMid
      )
...
//title
points.title = points.topMid.shiftFractionTowards(points.topMidCp2, 0.5)
.shift(-90, absoluteOptions.waistbandWidth * 0.5)
//button & buttonholes
points.button = points.bottomRightEx.shiftFractionTowards(points.topRight, 0.5)
points.buttonhole = paths.saBottom.shiftAlong(waistbandPlacketWidth * 0.5)
