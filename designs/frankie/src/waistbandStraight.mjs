...
//button & buttonholes
points.button = points.bottomRightEx.translate(waistbandPlacketWidth / -2, absoluteOptions.waistbandWidth / - 2)
points.buttonhole = points.bottomLeft.translate(waistbandPlacketWidth / 2, absoluteOptions.waistbandWidth / -2)
//foldline
if (options.waistbandFolded) {
  ...
  snippets.buttonF = new Snippet('button', points.buttonF)
            .attr('data-scale', 2)
