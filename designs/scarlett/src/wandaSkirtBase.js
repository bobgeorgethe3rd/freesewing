...
points.waistG = points.waistF.shiftTowards(points.origin.rotate(90, points.waistF), fullWaist * options.sidePanelFullness + hipDart / 2)
...
let waistFrontCpDistance = (4 / 3) * points.origin.dist(points.cfWaist) * Math.tan(utils.deg2rad((270 - points.origin.angle(points.waist1)) / 8))

points.waist0Cp1 = points.cfWaist.shiftTowards(points.origin, waistFrontCpDistance).rotate(90, points.cfWaist)
points.waist0Cp2 = points.waistPanel0.shiftTowards(points.origin, waistFrontCpDistance).rotate(-90, points.waistPanel0)
points.waist0Cp3 = points.waistPanel0.shiftTowards(points.origin, waistFrontCpDistance).rotate(90, points.waistPanel0)
points.waist0Left = points.waist1.shiftTowards(points.origin, dartExtension)
points.waist0Cp4 = points.waist0Left.shiftTowards(points.dartTipDCp1, waistFrontCpDistance).rotate(90, points.waist0Left)

let sideWaistFrontCpDistance = (4 / 3) * points.origin.dist(points.waist2) * Math.tan(utils.deg2rad((points.origin.angle(points.waist2) - points.origin.angle(points.waist3)) / 8))

points.waist1Right = points.waist2.shiftTowards(points.origin, dartExtension)
points.waist1Cp1 = points.waist1Right.shiftTowards(points.dartTipDCp3, sideWaistFrontCpDistance).rotate(-90, points.waist1Right)
points.waist1Cp2 = points.waistPanel1.shiftTowards(points.origin, sideWaistFrontCpDistance).rotate(-90, points.waistPanel1)
points.waist1Cp3 = points.waistPanel1.shiftTowards(points.origin, sideWaistFrontCpDistance).rotate(90, points.waistPanel1)
points.waist1Left = points.waist3.shiftTowards(points.origin, dartExtension)
points.waist1Cp4 = points.waist1Left.shiftTowards(points.dartTipECp1, sideWaistFrontCpDistance).rotate(90, points.waist1Left)

//shaping side panel
let sideWaistCpDistance0 = (4 / 3) * points.origin.dist(points.waist0) * Math.tan(utils.deg2rad((points.origin.angle(points.waist0) - points.origin.angle(points.waist4)) / 8))

points.waist2Right = points.waist0.shiftTowards(points.origin, dartExtension)
points.waist2Cp1 = points.waist2Right.shiftTowards(points.dartTipECp3, sideWaistCpDistance0).rotate(-90, points.waist2Right)
points.waist2Cp2 = points.waistPanel2.shiftTowards(points.origin, sideWaistCpDistance0).rotate(-90, points.waistPanel2)
points.waist2Cp3 = points.waistPanel2.shiftTowards(points.origin, sideWaistCpDistance0).rotate(90, points.waistPanel2)
points.waist2Left = points.waist4.shiftTowards(points.origin, dartExtension)
points.waist2Cp4 = points.waist2Left.shiftTowards(points.dartTipFCp1, sideWaistCpDistance0).rotate(	90, points.waist2Left)

let sideWaistCpDistance1 = (4 / 3) * points.origin.dist(points.waist5) * Math.tan(utils.deg2rad((points.origin.angle(points.waist5) - points.origin.angle(points.waist6)) / 8))

points.waist3Right = points.waist5.shiftTowards(points.origin, dartExtension)
points.waist3Cp1 = points.waist3Right.shiftTowards(points.dartTipFCp3, sideWaistCpDistance1).rotate(-90, points.waist3Right)
points.waist3Cp2 = points.waist3LeftS.shiftTowards(points.origin, sideWaistCpDistance1).rotate(-90, points.waist3LeftS)
points.waist3Cp2B = points.waist6B.shiftTowards(points.origin, sideWaistCpDistance1).rotate(-90, points.waist6B)
points.waist3Cp2U = points.waist6.shiftTowards(points.origin, sideWaistCpDistance1).rotate(-90, points.waist6)

//back panel shaping
points.waist6Cp1B = points.waist3Cp2B.rotate(180, points.waist6B)
points.waist6Cp2B = utils.beamsIntersect(points.waistEndB, points.waistEndB.shift(-90, 1), points.waist6B, points.waist6Cp1B)
points.waistL = utils.lineIntersectsCurve(points.waistA, points.hemL, points.waist6B, points.waist6Cp1B, points.waist6Cp2B, points.waistEndB)
...
points.dartTopD = utils.beamsIntersect(points.waist0Cp4, points.waist0Left, points.waist1Cp1, points.waist1Right)
points.dartTopE = utils.beamsIntersect(points.waist1Cp4, points.waist1Left, points.waist2Cp1, points.waist2Right)
points.dartTopF = utils.beamsIntersect(points.waist2Cp4, points.waist2Left, points.waist3Cp1, points.waist3Right)
//Uncomment to see how the scaffolding. Helpful if re-working please keep.

points.test = utils.beamsIntersect(points.waist0Left, points.dartTipDCp1, points.dartTipD, points.waistD)
paths.test = new Path()
.move(points.waist0Left)
._curve(points.test, points.dartTipD)
