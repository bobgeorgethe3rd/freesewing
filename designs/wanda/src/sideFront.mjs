  ...
  draft: ({
    ...
    if (complete) {
      ...
      if (options.pocketsBool) {
        points.pocketOpeningTop = paths.saLeft.shiftAlong(store.get('pocketOpening'))
        points.pocketOpeningBottom = paths.saLeft.shiftAlong(store.get('pocketOpeningLength'))
