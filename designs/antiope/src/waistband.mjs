...
export const waistband = {
  name: 'antiope.waistband',
  options: {
    //Imported
    ...waistbandStraight.options,
    ...waistbandCurved.options,
    //Style
    waistbandFolded: { bool: true, menu: 'style' }, //Altered for Antiope
    waistbandOverlapSide: { dflt: 'right', list: ['left', 'right'], menu: 'style' }, //Altered for Antiope
  },
  after: [back, placket],
