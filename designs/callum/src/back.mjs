...
export const back = {
  ...
  options: {
    //Dalton
    //Constants
    useVoidStores: false, //Locked for Callum
    fitWaist: false, //Locked for Callum
    legBandsBool: false, //Altered for Callum
    calculateLegBandDiff: false, //Locked for Callum
    hemWidth: 0.01, //Locked for Callum
    //Fit
    waistEase: { pct: 6.4, min: 0, max: 20, menu: 'fit' }, //Altered for Callum
    hipsEase: { pct: 5.9, min: 0, max: 20, menu: 'fit' }, //Altered for Callum
    seatEase: { pct: 5.1, min: 0, max: 20, menu: 'fit' }, //Altered for Callum
    kneeEase: { pct: 19.6, min: 0, max: 25, menu: 'fit' }, //Altered for Callum
    calfEase: { pct: 20.1, min: 0, max: 25, menu: 'fit' }, //Altered for Callum
    fitGuides: { bool: false, menu: 'fit' }, //Altered for Callum
    daltonGuides: { bool: false, menu: 'fit' },
    //Style
    waistHeight: { pct: 0, min: 0, max: 100, menu: 'style' }, //Altered for Callum
    waistbandWidth: {
      pct: 3.7,
      min: 1,
      max: 6,
    ...
    waistbandStyle: { dflt: 'straight', list: ['straight', 'curved'], menu: 'style' }, //Altered for Callum
    fitKnee: { bool: true, menu: 'style' }, //Altered for Callum
    ...
    fitWaistBack: { bool: true, menu: 'style' }, //Altered For Callum
    //Darts
    ...
    sideSeamSaWidth: { pct: 1, min: 1, max: 3, menu: 'construction' }, //Altered for Callum
    //Advanced
    backDartMultiplier: { count: 1, min: 0, max: 2, menu: 'advanced' }, //Altered for Callum
  },
