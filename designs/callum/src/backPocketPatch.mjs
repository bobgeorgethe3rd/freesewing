...
export const backPocketPatch = {
  name: 'callum.backPocketPatch',
  after: back,
  options: {
    //Pockets
    backPocketDepth: { pct: 12.6, min: 10, max: 20, menu: 'pockets.backPockets' },
    backPocketPatchStyle: {
      dflt: 'straight',
  ...
  draft: ({
    ...
    //draft
    if (options.backPocketStyle != 'patch') {
      part.hide()
      return part
    }
    ...
    macro('patchpocket', {
      ...
      style: options.backPocketPatchStyle,
