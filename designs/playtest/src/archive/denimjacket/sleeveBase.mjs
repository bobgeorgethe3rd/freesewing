...
export const sleeveBase = {
  ...
  options: {
    //Constants
    sleeveBands: true, //Locked for Playtest
    sleeveFlounces: false, //Locked for Playtest
    sleeveLength: 1, //Locked for Playtest
    sleeveHemWidth: 1, //Locked for Playtest
    //Fit
    sleeveGuides: { bool: false, menu: 'fit' },
    wristEase: { pct: 30.8, min: 0, max: 50, menu: 'fit' }, //Altered for Playtest
    //Sleeves
