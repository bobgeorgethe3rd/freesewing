...
export const frontBase = {
  ...
  options: {
    //Constants
    closurePosition: 'none', //Locked for Playtest
    hemWidth: 0, //Locked for Playtest
    //Fit
    chestEase: { pct: 21.7, min: 0, max: 30, menu: 'fit' }, //Altered for Playtest
    waistEase: { pct: 25.6, min: 0, max: 30, menu: 'fit' }, //Altered for Playtest
    ...
    //Construction
    armholeSaWidth: { pct: 1.5, min: 1, max: 3, menu: 'construction' }, //Altered for Playtest
