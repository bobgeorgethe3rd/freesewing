...
const EditFrankiePage = ({ page }) => {
  ...
  return (
    // prettier-ignore
    <PageWrapper {...page} title="Frankie" layout={pattern ? WorkbenchLayout : false} header={null}>
      {pattern ? (
        <EditDesignComponent
          id={pattern.id}
...
export default EditFrankiePage
