 ...
 */
import { Siona } from 'designs/siona/src/index.mjs'
// Dependencies
...
const EditSionaPage = ({ page }) => {
  ...
  return (
    // prettier-ignore
    <PageWrapper {...page} title="Siona" layout={pattern ? WorkbenchLayout : false} header={null}>
      {pattern ? (
        <EditDesignComponent
          id={pattern.id}
