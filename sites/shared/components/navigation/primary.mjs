...
const icons = {
  ...
  bodices: (className = '') => <BoxIcon className={className} />,
  bottoms: (className = '') => <BoxIcon className={className} />,
  community: (className = '') => <CommunityIcon className={className} />,
  collars: (className = '') => <BoxIcon className={className} />,
  costumes: (className = '') => <BoxIcon className={className} />,
  designs: (className = '') => <DesignIcon className={className} />,
  docs: (className = '') => <DocsIcon className={className} />,
  dresses: (className = '') => <BoxIcon className={className} />,
  garments: (className = '') => <DesignIcon className={className} />,
  guides: (className = '') => <GuideIcon className={className} />,
  hats: (className = '') => <BoxIcon className={className} />,
  howtos: (className = '') => <HelpIcon className={className} />,
  jackets: (className = '') => <BoxIcon className={className} />,
  jumpsuits: (className = '') => <BoxIcon className={className} />,
  pockets: (className = '') => <BoxIcon className={className} />,
  reference: (className = '') => <DocsIcon className={className} />,
  showcase: (className = '') => <ShowcaseIcon className={className} />,
  skirts: (className = '') => <BoxIcon className={className} />,
  sleeves: (className = '') => <BoxIcon className={className} />,
  swimwear: (className = '') => <BoxIcon className={className} />,
  tops: (className = '') => <BoxIcon className={className} />,
  tutorials: (className = '') => <TutorialIcon className={className} />,
  undergarments: (className = '') => <BoxIcon className={className} />,
  utilities: (className = '') => <CogIcon className={className} />,
  waistbands: (className = '') => <BoxIcon className={className} />,
}
